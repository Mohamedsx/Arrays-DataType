...
def binary_search(arr, target):
    ...
    while left <= right:
        ...
        if arr[mid][0] == target:
            ...
            right = mid - 1
    return -1
# function for my insertion sort
def insert_sort(arr):
...
# function to return players name
def player_s():
...
def my_game():
    ...
    if correct_guess == 6:
      ...
      print("SORRY, YOU HAVE LOST, Your Final Score is {}".format(player_score))
